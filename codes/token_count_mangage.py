# Install tiktoken. 
# Write a function that counts tokens in a prompt before sending it — 
# add an assert that it's under your context limit.
...
CONTEXT_LIMIT = 12000
OUTPUT_RESERVE = 4000
INPUT_BUDGET = CONTEXT_LIMIT - OUTPUT_RESERVE
...
def safe_chat(prompt: str) -> str:
    ...
    assert token_count <= INPUT_BUDGET, (
        f"Token budget exceeded: {token_count:,} > {INPUT_BUDGET:,}"
    )
